"""NutriBench v2 RAG task utilities.

doc_to_text_rag() uses the BenchRetriever to look up USDA nutrient values
and inject them into the prompt.  process_results and clean_output are
reused verbatim from the CoT task.
"""
...
# Singleton retriever — initialized once, reused across all samples
_retriever = None
...
def doc_to_text_rag(doc):
    """Build RAG-augmented prompt for a NutriBench sample."""
